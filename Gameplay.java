...
public class Gameplay{
    public Gameplay(){
        ...
        //int variables for each battle and opponent
        int damage = 0;
        int dummy = 20;
        int health = 30;
        int goblin = 40;
        //dialogue with some questions
        ...
        if (villageElder.equals("yes")){
            ...
            System.out.println("You son of a gremlin");
            System.out.println(" ");
            System.out.println("*You enter into a figth with the elder!!!*");
            System.out.println(" ");
            System.out.println("*He is incredibly fast and strong you weakling!!!*");
            System.out.println(" ");
            System.out.println("Do you attack or flee?");
            String eldFight = elderFight.nextLine();
            if(eldFight.equals("attack")){
                System.out.println("In one slash, the elder defeated you!!!");
                health -= 30;
        ...
        System.out.println("*After saying goodbyes and practicing some more, you are finally ready to set off on your journey*");
        System.out.println(" ");
